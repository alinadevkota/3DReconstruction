...
class Example:
    def __init__(self, num_envs=8):
        ...
        # Parse the URDF file for the cartpole
        wp.sim.parse_urdf(
        ...
        # Add environments (instances of the cartpole)
        ...
        # Define the integrator for simulation
        self.integrator = wp.sim.SemiImplicitIntegrator()

        # Use OpenGL renderer
        self.renderer = wp.render.OpenGLRenderer(scaling=15.0)
    ...
    def render(self):
        ...
        with wp.ScopedTimer("render"):
            ...
            print(dir(self.renderer))  # Check available methods
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_frames", type=int, default=1200, help="Total number of frames."
    )
    parser.add_argument(
        "--num_envs",
        type=int,
